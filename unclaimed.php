...
<body>
	<div class="unidentified-banner">
		...
		<div class="unidentified-content">
			<div class="top-text">
				<h1>UNCLAIMED PERSONS</h1>
				<p>The following are individuals listed as unclaimed.</p>
			</div>
			<hr><br>
			<form action="search.php" method="POST">
				<label>Filter by:</label>
				<input type="text" name="name" placeholder="Enter the name..." style="width: 200px;">
				<label>Filter by:</label>
				<select name="gender" >
				...
				<input type="text" name="state"hidden value="unclaimed">
				<button type="reset">Reset</button>
				<button type="submit" name="submit-search">Filter</button>
			</form><br>
			<div class="cases-container">
				<?php
				$sql = "SELECT * FROM cases WHERE state='unclaimed' ORDER BY caseId DESC";
