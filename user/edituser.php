		...
		<div class="upload">
			<form action="../include/newcase.inc.php" method="post" enctype="multipart/form-data">
				...
				<div class="form">
					<div class="left">
						<label>Name</label>
						<input type="text" name="name" placeholder="Enter name of victim..." value="<?php echo $row['name']; ?>">
						<label>Gender</label>
						<select name="gender">
						...
						<textarea name="description" rows="10" cols="50" placeholder="Enter description of the person..." value="<?php echo $row['description']; ?>"></textarea><br>
					</div>
					<div class="right">
						...
						<textarea name="narrative" rows="10" cols="50" placeholder="Enter details of the case.." value="<?php echo $row['narrative']; ?>"></textarea><br>
					</div>
